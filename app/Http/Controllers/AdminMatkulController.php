<?php namespace App\Http\Controllers;
	...
	class AdminMatkulController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Jurusan','name'=>'jurusan','type'=>'select','validation'=>'required','width'=>'col-sm-9','dataenum'=>'SEJARAH DAN PERADABAN ISLAM;SATRA INGGRIS'];
